			...
			<div class="cell small-12 medium-12 large-8">
				<article class="gc-news">
					...
					<div class="filter-content">
						...
						{
							echo do_shortcode('[ajax_load_more container_type="div" post_type="post" category="videos" scroll="false" progress_bar="true" progress_bar_color="1f6ae1" button_loading_label="Carregando..."]');
						}	else {
							echo do_shortcode('[ajax_load_more container_type="div" post_type="post" category="videos" scroll="false" button_loading_label="Loading..."]');
						}
					?>
