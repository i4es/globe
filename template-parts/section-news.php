	...
	<div class="grid-container">
		...
		<div class="grid-x grid-margin-x">
			<div class="cell small-12 medium-4 large-4">
					...
					<li class="gc-news-list-item">
						<div class="gc-news-img-wraper">
							<div class="gc-news-category">
								<a href="<?php echo get_page_link( 139 ); ?>">News</a>
							</div>
						...
						<div class="gc-news-content">
							...
							<div class="gc-news-description">
								<?php echo excerpt(20); ?>
								<a class="cg-front-news-read-more" href="<?php the_permalink(); ?>" target="_blank">Read More</a>
							</div>
						</div>
						<!-- /.gc-news-content -->
					</li>
				...
				<a class="gc-news-category-link" href="<?php echo get_page_link( 139 ); ?>">View All</a>
			</div>
			...
			<div class="cell small-12 medium-4 large-4">
				<ul class="gc-news-list">
					...
					<li class="gc-news-list-item">
						<div class="gc-news-img-wraper">
							<div class="gc-news-category">
								<a href="<?php echo get_page_link( 2544 ); ?>">Video</a>
							</div>
				...
				<a class="gc-news-category-link" href="<?php echo get_page_link( 2544 ); ?>">View All</a>
			</div>
			<!-- /.cell small-12 medium-4 large-4 -->
			...
			<div class="cell small-12 medium-4 large-4">
				<ul class="gc-news-list">
					...
					<li class="gc-news-list-item">
						<div class="gc-news-img-wraper">
							<div class="gc-news-category">
								<a href="<?php echo get_page_link( 687 ); ?>">Publications</a>
							</div>
				...
				<a class="gc-news-category-link" href="<?php echo get_page_link( 687 ); ?>">View All</a>
			</div>
			<!-- /.cell small-12 medium-4 large-4 -->
		</div>
		<!-- /.grid-x grid-margin-x -->
